...
import 'package:workspace/features/admin/notification/e_leave_detail.dart';
import 'package:workspace/features/dashboard/service/leave_request_service.dart';

class ELeaveRequest extends StatefulWidget {
  const ELeaveRequest({super.key, this.user});
  final UserModel? user;

  @override
  State<ELeaveRequest> createState() => _ELeaveRequestState();
}

class _ELeaveRequestState extends State<ELeaveRequest> {
