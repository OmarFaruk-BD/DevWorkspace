...
class EEmergencyRequest extends StatefulWidget {
  const EEmergencyRequest({super.key, this.user});
  final UserModel? user;

  @override
  State<EEmergencyRequest> createState() => _EEmergencyRequestState();
}

class _EEmergencyRequestState extends State<EEmergencyRequest> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AdminAppBar(
        title: 'Employee Emergency Requests',
