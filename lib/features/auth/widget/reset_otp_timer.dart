...
class ResetOTPTimer extends StatefulWidget {
  const ResetOTPTimer({super.key, this.email});

  final String? email;

  @override
  State<StatefulWidget> createState() => _ResetOTPTimerState();
}

class _ResetOTPTimerState extends State<ResetOTPTimer>
  ...
  Future<void> _reSendOTP() async {
    ...
    final result = await AuthService().resetPassword(widget.email ?? '');
    if (!mounted) return;
    result.fold(
